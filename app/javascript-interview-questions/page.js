    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-white mb-3">JavaScript Interview Questions</h1>
                    <p className="text-gray-400">
                        Comprehensive list of <strong>JavaScript technical interview questions</strong> covering scope, closures, promises, and more.
                        Ideal for <strong>frontend developer interviews</strong>.
                    </p>
                </div>
